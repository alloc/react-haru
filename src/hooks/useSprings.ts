...
import { is, each, usePrev, useOnce, useForceUpdate } from '../shared'
...
import { declareUpdate } from '../core/SpringValue'
import {
  Controller,
  getSprings,
  flushUpdateQueue,
...
import { hasProps, detachRefs, replaceRef } from '../core/helpers'
...
export function useSprings(
  ...
  const propsFn = is.function(props) && props
