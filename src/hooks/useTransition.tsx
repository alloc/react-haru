...
import { OneOrMore, UnknownProps } from '../types'
import { is, toArray, useForceUpdate, useOnce, usePrev, each } from '../shared'
...
import { Controller, getSprings, setSprings } from '../core/Controller'
import { SpringContext } from '../core/SpringContext'
...
export function useTransition(
  ...
  each(transitions, (t, i) => {
    ...
    if (phase == ENTER && is.undefined(payload.from)) {
      ...
      const from =
        is.undefined(props.initial) || prevTransitions
          ? props.from
          : props.initial
